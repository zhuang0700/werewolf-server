...
public enum GameMsgSubType {
    ...
    KILL_ACTION("{0}号玩家（狼人）选择了{2}号作为目标",5,5001),
    CURE_ACTION("{0}号玩家（女巫）选择对{2}号使用解药",5,5002),
    POSITION_ACTION("{0}号玩家（女巫）选择对{2}号使用毒药",5,5003),
    SHOOT_ACTION("{0}号玩家（猎人）选择开枪带走{2}号",5,5004),
    SEER_ACTION("{0}号玩家（预言家）查验了{2}号（{3}）的身份",5,5005),
