...
import com.telan.werewolf.model.MsgType;
import com.telan.werewolf.model.request.*;
...
public class BaseParser implements Parser<BaseReqMsg, BaseRspMsg> {
	...
	public static void main(String[] args) {
		...
		*/
		String xml = "<com.yimayhd.werewolf.model.response.ImageTextArticles><ToUserName><![CDATA[toUser]]></ToUserName><FromUserName><![CDATA[fromUser]]></FromUserName><CreateTime>1348831860</CreateTime>";
		xml += " <MsgType><![CDATA[text]]></MsgType><Content><![CDATA[this is a test]]></Content><MsgId>1234567890123456</MsgId></com.yimayhd.werewolf.model.response.ImageTextArticles>";
		XStream xstream = new XStream(new WeixinXppDriver());
		xstream.autodetectAnnotations(true);
